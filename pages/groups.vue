<template>
    <v-app>
        <v-container>
            ...
            <v-divider />
            <v-row class="groups-row">
                <v-card class="card"
                    v-for="(group, i) in userGroups" :key="i"
                    width="150px"
                >
                    ...
                    <v-card-subtitle>{{group.groupid}}</v-card-subtitle>
                    <v-card-text>{{group.joincode}}</v-card-text>
                </v-card>
            </v-row>
        </v-container>
    </v-app>
